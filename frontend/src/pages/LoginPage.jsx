...
const LoginPage = () => {
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 md:px-16 lg:px-20 bg-white">
        ...
        >
          ...
          {/* Heading */}
          <h1 className="text-3xl font-extrabold text-[#0f1d33] text-center mb-2 leading-none">Welcome Back !</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email */}
            <div>
              <label className="block text-sm font-bold text-[#0f1d33] mb-1.5">Email Address</label>
              <input
            ...
            {/* Password */}
            <div>
              <label className="block text-sm font-bold text-[#0f1d33] mb-1.5">Password</label>
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-sm text-[#085448] hover:text-[#063d34] font-medium transition-colors">
                Forgot Password?
              </button>
            </div>
  ...
  className={`w-full py-3 px-4 rounded-lg font-semibold text-sm text-white transition-all duration-200 flex items-center justify-center gap-2
    ${isLoading 
      ? 'bg-[#7aaea6] cursor-not-allowed' 
      : 'bg-[#085448] hover:bg-[#063d34] active:scale-[0.98] shadow-lg shadow-[#085448]/30'
    }`}
>
                {isLoading ? (
  ...
  <span className="text-[#085448] cursor-pointer hover:underline">
    Terms of Service
  </span>{' '}
  and{' '}
  <span className="text-[#085448] cursor-pointer hover:underline">
...
<Link to="/signup"className="text-[#085448] font-semibold hover:text-[#063d34] transition-colors">Sign Up</Link>
          </p>
        </motion.div>
      </div>

      {/* Right Panel - Green Illustration */}
       <div className="hidden lg:flex lg:w-[50%] bg-gradient-to-br from-[#085448] to-[#063d34] relative overflow-hidden items-center justify-center p-10">        {/* Background decorative elements */}
